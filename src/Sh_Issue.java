...
public class Sh_Issue extends javax.swing.JInternalFrame {

    /**
     * Creates new form Sh_Issue
     */
    public Sh_Issue() {
        initComponents();
    }
    ...
    private void bt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt1ActionPerformed
        ...
        try
        {
            try
            {
                ...
                sql = "select * from Issue "+sort+order+" ; ";
