...
public class En_Member extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(bt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, -1, -1));
        ...
        jPanel1.add(bt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, -1, -1));
        ...
        jPanel1.add(bt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 350, -1, -1));
        ...
        lb6.setText("STATUS :");
        jPanel1.add(lb6, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 90, -1));
        ...
        tf6.setOpaque(true);
        jPanel1.add(tf6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 300, 60, 30));

        lb4.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        lb4.setText("MOBILE :");
        jPanel1.add(lb4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, 110, -1));

        lb5.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        lb5.setText("ADDRESS :");
        jPanel1.add(lb5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 110, -1));
    ...
    private void cal_mno()
    {
          ...
          try
          {
               ...
               { 
                     ...
                     sql = "select max(mno) as mx from Member ;";
    ...
    private void bt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt1ActionPerformed
        ...
        try
        {
            try
            {
                ...
                sql = "insert into member values("+tf1.getText()+",'"+tf2.getText()
    ...
    private void tf5KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf5KeyTyped
        ...
        if(ch == '\n')
        {
            tf5.setText(En_Almirah.toTitleCase(tf5.getText()));
            bt1.doClick();
        }
